...
public sealed class BeachHouse : LegacyStructure {
    public static readonly string _filePath = "Core/Assets/StructureFiles/beachHouse/beachHouse_v2.shstruct";
    public static readonly string _filePath_r = "Core/Assets/StructureFiles/beachHouse/beachHouse_v2_r.shstruct";
    public static readonly ushort _structureXSize = 35;
    public static readonly ushort _structureYSize = 26;

    public static readonly string _filePathNoDeck = "Core/Assets/StructureFiles/beachHouse/beachHouse_v2_NoDeck.shstruct";
