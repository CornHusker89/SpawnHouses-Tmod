...
public class StructureLayoutParams {
    public class StructureLayoutParams : Params {
        public readonly bool CanAddEntryPoints;
        public readonly EntryPoint[] EntryPoints;
        public readonly int Size;
        public readonly TagMap TagsRequired;

        public StructureLayoutParams(TagMap tagsRequired, Path groundPath, EntryPoint[] entryPoints, int size, bool canAddEntryPoints, int seed = -1, bool generate = true) {
