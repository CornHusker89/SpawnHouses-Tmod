...
public class GetPlayersCommand : IChatCommand
{
	private static readonly Color RESPONSE_COLOR = new Color(20, 240, 240);

	public void ProcessIncomingMessage(string text, byte clientId)
	{
		ChatHelper.SendChatMessageToClient(GetPlayersCommand.ComposeMessage(GetPlayersCommand.GetCommandAliasesByID()), GetPlayersCommand.RESPONSE_COLOR, clientId);
	}
