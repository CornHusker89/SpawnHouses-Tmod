...
namespace SpawnHouses.StructureHelper
{
	...
	public static class Generator
	{
		...
		/// <param name="tileChances">Dict of the tiles that don't have a 100% chance to spawn. value represents 0-100 percent chance to spawn.</param>
		/// <returns>If the structure generated successfully or not</returns>
		public static bool GenerateStructure(string path, Point16 pos, Mod mod, bool fullPath = false, bool ignoreNull = false, GenFlags flags = GenFlags.None, Dictionary<ushort, byte> tileChances = null)
		{
		...
		/// <param name="tileChances">A Dict of the tiles that don't have a 100% chance to spawn. value represents 0-100 percent chance</param>
		/// <returns>If the structure successfully generated or not</returns>
		public static unsafe bool Generate(TagCompound tag, Point16 pos, bool ignoreNull = false, GenFlags flags = GenFlags.None, Dictionary<ushort, byte> tileChances = null)
		{
