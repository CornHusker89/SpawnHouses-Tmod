...
public struct TileSaveData : TagSerializable {
    ...
    public TileSaveData(string tile, string wall, short frameX, short frameY, int wallWireData, short packedLiquidData,
        byte brightInvisibleData, string teType = "", TagCompound teData = null) {
        this.tile = tile;
        this.wall = wall;
        this.frameX = frameX;
        this.frameY = frameY;
