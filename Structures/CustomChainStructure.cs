...
<<<<<<<<
Legacy / Structures / CustomChainStructure.cs
using SpawnHouses.Legacy.Structures;
using SpawnHouses.Structures.StructureParts;
    ========
using SpawnHouses.Helpers;
>>>>>>>>
Types / CustomChainStructure.cs
...
public class CustomChainStructure : CustomStructure {
    ...
    public ChainConnectPoint ParentChainConnectPoint;
        <<<<<<<< HEAD:Legacy/Structures/CustomChainStructure.cs
    ...
    public BoundingBox[] StructureBoundingBoxes;
        >>>>>>>> master:Types/CustomChainStructure.cs
