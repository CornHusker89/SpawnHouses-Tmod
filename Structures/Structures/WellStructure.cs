...
public sealed class WellStructure : CustomStructure
{
    
    // constants
    public static readonly string _filePath = "Structures/StructureFiles/well";
    ...
    public WellStructure(ushort x = 0, ushort y = 0) :
