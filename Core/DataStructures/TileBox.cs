...
public readonly struct TileBox {
    ...
    /// <summary>
    ///     ADDs the offset to the current position. for setting an absolute position, see <see cref="SetPosition"/>
    /// </summary>
    ...
    /// <summary>
    ///     creates a 4-point path, in world coordinates, around the outside of this box
    /// </summary>
    /// <returns></returns>
    public Point[] GetDrawPath() => [
        TopLeftPoint * new Point(16, 16), // TL
        TopRightPoint * new Point(16, 16) + new Point(15, 0), // TR
        BottomRightPoint * new Point(16, 16) + new Point(15, 15), // BR
        BottomLeftPoint * new Point(16, 16) + new Point(0, 15) // BL
    ];
}