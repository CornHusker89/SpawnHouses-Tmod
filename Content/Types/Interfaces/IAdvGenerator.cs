...
public interface IAdvGenerator {
    ...
    /// <summary>
    ///     execute the advGenerator with the given parameters. alters structure <see cref="AdvStructure.Tilemap" />, sets <see cref="IComponent.TagsCurrent" /> for this module
    /// </summary>
