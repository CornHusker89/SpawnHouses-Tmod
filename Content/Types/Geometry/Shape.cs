...
namespace SpawnHouses.Content.Types.Geometry;
...
public class Shape : PointGeometry {
    ...
    private Point[]? _exteriorDrawPath;
...
#pragma warning restore CS8618
    ...
    /// </summary>
    /// <returns></returns>
    private Point[] GetExteriorDrawPath() {
        List<Point> path = [];
            ...
            for (int i = 0; i < 8; i++) {
                ...
                switch (direction) {
                    case Direction.UpRight:
                        path.Add((pos.ToPoint() + BoundingBox.TopLeftPoint) * new Point(16, 16) + new Point(16, 0));
                        break;
                    case Direction.DownRight:
                        path.Add((pos.ToPoint() + BoundingBox.TopLeftPoint) * new Point(16, 16) + new Point(16, 16));
                        break;
                    case Direction.DownLeft:
                        path.Add((pos.ToPoint() + BoundingBox.TopLeftPoint) * new Point(16, 16) + new Point(0, 16));
                        break;
                    case Direction.UpLeft:
                        path.Add((pos.ToPoint() + BoundingBox.TopLeftPoint) * new Point(16, 16) + new Point(0, 0));
                        break;
                }
